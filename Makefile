# This Makefile is for the Maypole::Plugin::Exception extension to perl.
#
...
#     NAME => q[Maypole::Plugin::Exception]
#     PREREQ_PM => { Exception::Class=>q[0], Maypole=>q[2.0] }
...
NAME_SYM = Maypole_Plugin_Exception
VERSION = 0.03
...
FULLEXT = Maypole/Plugin/Exception
BASEEXT = Exception
...
PM_TO_BLIB = Exception.pm \
	$(INST_LIB)/Maypole/Plugin/Exception.pm
...
DISTNAME = Maypole-Plugin-Exception
DISTVNAME = Maypole-Plugin-Exception-0.03
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  Exception.pm $(INST_MAN3DIR)/Maypole::Plugin::Exception.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/Maypole/Plugin/Exception.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Maypole-Plugin-Exception' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.03' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: Exception.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    Exception::Class:              0' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  Exception.pm $(INST_LIB)/Maypole/Plugin/Exception.pm 
	$(NOECHO) $(TOUCH) $@
